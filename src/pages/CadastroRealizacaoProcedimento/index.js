  ...
  render() {
    ...
    return (
      <Container>
        ...
        >
          <CardHeader
            subheader="Solicita̤̣o de um novo procedimento"
            ...
            >
              ...
              >
                <TextField
                  ...
                  margin="dense"
                  name="tipoAvaliacao"
                  onChange={event => this.setState({disciplina: event.target.value})}
                  required
                  select
                  value={disciplina}
                  variant="outlined"
              ...
              >
                <TextField
                  fullWidth
                  helperText="Por favor, selecione a Regịo"
                  label="Regịo"
                  margin="dense"
                  name="tipoAvaliacao"
                  onChange={event => this.setState({regiao: event.target.value})}
                  required
                  select
                  value={regiao}
                  variant="outlined"
              ...
              >
                <TextField
                  ...
                  margin="dense"
                  name="tipoAvaliacao"
                  onChange={event => this.setState({procedimento: event.target.value})}
                  required
                  select
                  value={procedimento}
                  variant="outlined"
